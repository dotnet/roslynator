...
{
    public override DiagnosticDescriptor Descriptor { get; } = FormattingDiagnosticRules.AddBlankLineAfterEmbeddedStatement;

    [Fact, Trait(Traits.Analyzer, FormattingDiagnosticIds.AddBlankLineAfterEmbeddedStatement)]
