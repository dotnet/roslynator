...
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(ConditionalExpressionCodeCodeRefactoringProvider))]
    public class ConditionalExpressionCodeCodeRefactoringProvider : CodeRefactoringProvider
    {
