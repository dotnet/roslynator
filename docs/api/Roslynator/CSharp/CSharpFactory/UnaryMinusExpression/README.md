...
## UnaryMinusExpression\(ExpressionSyntax\) <a id="Roslynator_CSharp_CSharpFactory_UnaryMinusExpression_Microsoft_CodeAnalysis_CSharp_Syntax_ExpressionSyntax_"></a>
...
## UnaryMinusExpression\(ExpressionSyntax, SyntaxToken\) <a id="Roslynator_CSharp_CSharpFactory_UnaryMinusExpression_Microsoft_CodeAnalysis_CSharp_Syntax_ExpressionSyntax_Microsoft_CodeAnalysis_SyntaxToken_"></a>
