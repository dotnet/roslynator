...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ReplaceForEachWithForCodeFixProvider))]
    [Shared]
    public class ReplaceForEachWithForCodeFixProvider : BaseCodeFixProvider
    {
