...
namespace Roslynator.CSharp.Refactorings.UnusedSyntax
{
    internal static class UnusedSyntaxRefactoring
    {
        ...
        public static UnusedLocalFunctionParameterRefactoring UnusedLocalFunctionParameter { get; } = new UnusedLocalFunctionParameterRefactoring();
        ...
        public static UnusedLocalFunctionTypeParameterRefactoring UnusedLocalFunctionTypeParameter { get; } = new UnusedLocalFunctionTypeParameterRefactoring();
    }
}
