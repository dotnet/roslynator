...
namespace Roslynator.CSharp.DiagnosticAnalyzers
{
    ...
    public class UseIsOperatorInsteadOfAsOperatorDiagnosticAnalyzer : BaseDiagnosticAnalyzer
    {
        ...
        private void AnalyzeEqualsExpression(SyntaxNodeAnalysisContext context)
        {
            ...
            UseIsOperatorInsteadOfAsOperatorRefactoring.AnalyzeEqualsExpression(context);
        }
        ...
        private void AnalyzeNotEqualsExpression(SyntaxNodeAnalysisContext context)
        {
            ...
            UseIsOperatorInsteadOfAsOperatorRefactoring.AnalyzeNotEqualsExpression(context);
        }
    }
}
