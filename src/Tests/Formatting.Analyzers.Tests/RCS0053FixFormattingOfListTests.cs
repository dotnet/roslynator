...
{
    public override DiagnosticDescriptor Descriptor { get; } = FormattingDiagnosticRules.FixFormattingOfList;

    [Fact, Trait(Traits.Analyzer, FormattingDiagnosticIds.FixFormattingOfList)]
