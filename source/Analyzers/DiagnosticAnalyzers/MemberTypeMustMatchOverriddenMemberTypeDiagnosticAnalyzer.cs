...
using static Roslynator.CSharp.Refactorings.MemberTypeMustMatchOverriddenMemberTypeRefactoring;

namespace Roslynator.CSharp.DiagnosticAnalyzers
{
    [DiagnosticAnalyzer(LanguageNames.CSharp)]
    public class MemberTypeMustMatchOverriddenMemberTypeDiagnosticAnalyzer : BaseDiagnosticAnalyzer
    {
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics
        {
            get { return ImmutableArray.Create(DiagnosticDescriptors.MemberTypeMustMatchOverriddenMemberType); }
        }
