    ...
    public class AssignDefaultValueToOutParameterCodeFixProvider : BaseCodeFixProvider
    {
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            SyntaxNode node = root
                ...
                .FirstAncestorOrSelf(f => f.IsKind(SyntaxKind.MethodDeclaration) || f is StatementSyntax);
            ...
            StatementSyntax statement)
        {
            ...
            StatementSyntax lastStatement = statements.LastOrDefault(f => !f.IsKind(SyntaxKind.ReturnStatement));
