...
{
    public override DiagnosticDescriptor Descriptor { get; } = FormattingDiagnosticRules.PlaceNewLineAfterOrBeforeEqualsToken;

    [Fact, Trait(Traits.Analyzer, FormattingDiagnosticIds.PlaceNewLineAfterOrBeforeEqualsToken)]
