...
{
    public override DiagnosticDescriptor Descriptor { get; } = FormattingDiagnosticRules.RemoveBlankLineBetweenUsingDirectivesWithSameRootNamespace;

    [Fact, Trait(Traits.Analyzer, FormattingDiagnosticIds.RemoveBlankLineBetweenUsingDirectivesWithSameRootNamespace)]
