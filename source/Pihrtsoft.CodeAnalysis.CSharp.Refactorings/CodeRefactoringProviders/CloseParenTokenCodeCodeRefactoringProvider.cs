...
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(CloseParenTokenCodeCodeRefactoringProvider))]
    public class CloseParenTokenCodeCodeRefactoringProvider : CodeRefactoringProvider
    {
