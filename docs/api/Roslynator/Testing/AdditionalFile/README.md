...
| Constructor | Summary |
| ----------- | ------- |
| [AdditionalFile(String, String)](-ctor/README.md) | Initializes a new instance of [AdditionalFile](./README.md) |

## Properties

| Property | Summary |
| -------- | ------- |
| [ExpectedSource](ExpectedSource/README.md) | Gets expected source code\. |
| [Source](Source/README.md) | Gets a source code\. |
