...
{
    public override DiagnosticDescriptor Descriptor { get; } = FormattingDiagnosticRules.AddBlankLineBeforeTopDeclaration;

    [Fact, Trait(Traits.Analyzer, FormattingDiagnosticIds.AddBlankLineBeforeTopDeclaration)]
