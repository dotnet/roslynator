...
* [Extract expression from parentheses](source/Refactorings/README.md#extract-expression-from-parentheses)
...
* [Wrap expression in parentheses](source/Refactorings/README.md#wrap-expression-in-parentheses)
* [Wrap in #if directive](source/Refactorings/README.md#wrap-in-if-directive)
* [Wrap in if statement](source/Refactorings/README.md#wrap-in-if-statement)
