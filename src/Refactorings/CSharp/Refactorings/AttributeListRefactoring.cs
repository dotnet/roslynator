...
namespace Roslynator.CSharp.Refactorings
{
    internal static class AttributeListRefactoring
    {
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            newLists.AddRange(attributeLists.SelectMany(SyntaxRefactorings.SplitAttributes).Select(f => f.WithFormatterAnnotation()));
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            newLists.Add(SyntaxRefactorings.MergeAttributes(attributeLists).WithFormatterAnnotation());
