...
{
    public override DiagnosticDescriptor Descriptor { get; } = FormattingDiagnosticRules.PutEnumMemberOnItsOwnLine;

    [Fact, Trait(Traits.Analyzer, FormattingDiagnosticIds.PutEnumMemberOnItsOwnLine)]
