...
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(SyntaxTokenCodeRefactoringProvider))]
    public class SyntaxTokenCodeRefactoringProvider : CodeRefactoringProvider
    {
        ...
        public static async Task<Document> NegateOperatorAsync(
            Document document,
