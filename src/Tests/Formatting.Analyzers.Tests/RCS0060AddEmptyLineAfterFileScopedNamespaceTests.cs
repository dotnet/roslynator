...
{
    public override DiagnosticDescriptor Descriptor { get; } = FormattingDiagnosticRules.BlankLineAfterFileScopedNamespaceDeclaration;

    [Fact, Trait(Traits.Analyzer, FormattingDiagnosticIds.BlankLineAfterFileScopedNamespaceDeclaration)]
