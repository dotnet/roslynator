...
##### Roslynator
* [Extension for Visual Studio 2015](http://visualstudiogallery.msdn.microsoft.com/e83c5e41-92c5-42a3-80cc-e0720c621b5e) that contains both analyzers and refactorings.

##### Roslynator 2017
* [Extension for Visual Studio 2017](http://marketplace.visualstudio.com/items?itemName=josefpihrt.Roslynator2017) that contains both analyzers and refactorings.

##### Roslynator Refactorings
* [Extension for Visual Studio 2015](http://visualstudiogallery.msdn.microsoft.com/a9a2b4bc-70da-437d-9ab7-b6b8e7d76cd9) that contains only refactorings.

##### Roslynator Refactorings 2017
* [Extension for Visual Studio 2017](http://marketplace.visualstudio.com/items?itemName=josefpihrt.RoslynatorRefactorings2017) that contains only refactorings.
...
* [Call 'To...' method (ToString, ToArray, ToList)](source/Refactorings/README.md#call-to-method-tostring-toarray-tolist)
...
* [Generate event invoking method](source/Refactorings/README.md#generate-event-invoking-method)
...
* [Make member virtual](source/Refactorings/README.md#make-member-virtual)
* [Mark all members as static](source/Refactorings/README.md#mark-all-members-as-static)
* [Mark containing class as abstract](source/Refactorings/README.md#mark-containing-class-as-abstract)
...
* [Merge string expressions](source/Refactorings/README.md#merge-string-expressions)
...
* [Replace Any with All (or All with Any)](source/Refactorings/README.md#replace-any-with-all-or-all-with-any)
...
* [Replace Count property with Length property (or Length with Count)](source/Refactorings/README.md#replace-count-property-with-length-property-or-length-with-count)
...
* [Replace for statement with while statement](source/Refactorings/README.md#replace-for-statement-with-while-statement)
* [Replace foreach statement with for statement](source/Refactorings/README.md#replace-foreach-statement-with-for-statement)
* [Replace HasFlag invocation with bitwise operation](source/Refactorings/README.md#replace-hasflag-invocation-with-bitwise-operation)
* [Replace if statement with return statement](source/Refactorings/README.md#replace-if-statement-with-return-statement)
* [Replace if-else with assignment](source/Refactorings/README.md#replace-if-else-with-assignment)
