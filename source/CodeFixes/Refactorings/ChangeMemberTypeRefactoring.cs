...
namespace Roslynator.CSharp.Refactorings
{
    internal static class ChangeMemberTypeRefactoring
    {
             ...
             SemanticModel semanticModel)
        {
            ...
            SymbolAndTypeSymbol symbolAndTypeSymbol = GetContainingSymbolAndType(expression, semanticModel, context.CancellationToken);

            ISymbol symbol = symbolAndTypeSymbol.Symbol;
            ITypeSymbol typeSymbol = symbolAndTypeSymbol.TypeSymbol;
        ...
        private static SymbolAndTypeSymbol GetContainingSymbolAndType(
            ExpressionSyntax expression,
            SemanticModel semanticModel,
                ...
                case IMethodSymbol methodSymbol:
                    {
                        ...
                        if (methodKind == MethodKind.PropertyGet)
                        {
                            ...
                            return new SymbolAndTypeSymbol(propertySymbol, propertySymbol.Type);
                        }
                        ...
                        return new SymbolAndTypeSymbol(methodSymbol, methodSymbol.ReturnType);
                    }
                case IFieldSymbol fieldSymbol:
                    {
                        return new SymbolAndTypeSymbol(fieldSymbol, fieldSymbol.Type);
                    }
            }

            Debug.Assert(false, expression.ToString());

            return default(SymbolAndTypeSymbol);
        }
        ...
        private struct SymbolAndTypeSymbol
        {
            public SymbolAndTypeSymbol(ISymbol symbol, ITypeSymbol typeSymbol)
            {
                Symbol = symbol;
