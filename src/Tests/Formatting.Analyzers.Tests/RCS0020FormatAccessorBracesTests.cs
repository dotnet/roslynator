...
{
    public override DiagnosticDescriptor Descriptor { get; } = FormattingDiagnosticRules.FormatAccessorBraces;

    [Fact, Trait(Traits.Analyzer, FormattingDiagnosticIds.FormatAccessorBraces)]
