...
Contributor workflows for AI agents (Cursor, Claude Code) live in [.claude/skills/](.claude/skills/) — adding analyzers, 
refactorings, compiler fixes, bug fixes, deprecation, and releases.
