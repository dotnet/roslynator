...
- Fix analyzer [RCS1192](https://josefpihrt.github.io/docs/roslynator/analyzers/RCS1192) to report unnecessary verbatim strings in `[GeneratedRegex]` and other attributes in user source ([#1714](https://github.com/dotnet/roslynator/issues/1714)) ([PR](https://github.com/dotnet/roslynator/pull/1805))
