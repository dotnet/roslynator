...
namespace Roslynator.CSharp.DiagnosticAnalyzers
{
    ...
    public class UnusedParameterDiagnosticAnalyzer : BaseDiagnosticAnalyzer
    {
        ...
        {
            get { return ImmutableArray.Create(DiagnosticDescriptors.UnusedParameter); }
        }
        ...
        public override void Initialize(AnalysisContext context)
        {
            ...
            context.RegisterSyntaxNodeAction(f => LocalFunctionStatement(f), SyntaxKind.LocalFunctionStatement);
        }
    }
}
