...
{
    public override DiagnosticDescriptor Descriptor { get; } = FormattingDiagnosticRules.PutAutoAccessorsOnSingleLine;

    [Fact, Trait(Traits.Analyzer, FormattingDiagnosticIds.PutAutoAccessorsOnSingleLine)]
