...
{
    public override DiagnosticDescriptor Descriptor { get; } = FormattingDiagnosticRules.NormalizeWhitespaceAtEndOfFile;

    [Fact, Trait(Traits.Analyzer, FormattingDiagnosticIds.NormalizeWhitespaceAtEndOfFile)]
